...
def main():
    ...
    #from Denoising.diffusion.datasets.dataset_cococap import Dataset_Cococap as Dataset_class
    Dataset_class = get_dataset(args.dataset_type) #ConcatModel_wrappret_class(UNetModel) #ConcatModelCon
    # from dataset_cococap import Dataset_Cococap_clipimg as Dataset_class
